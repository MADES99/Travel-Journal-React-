...
export default function TravelCard(props) {
    return (    
            <div className='travel-card'>
                <img src={props.travel.imageUrl} alt='travel-img' className="travel--image"/>
                <div className='travel-info'>
                    <div className='travel-location'>
                        <h2 className="travel-site"> 
                        ...
                        <a href={props.travel.googleMapsUrl} className="map--link">View on Google Maps</a>
                    </div>
                    <h1 className='travel-location-name'>{props.travel.title}</h1>
                    <p className='travel-duration'>{props.travel.startDate} - {props.travel.endDate}</p>
